...
roomList[3] =  {shape:"BarShape", player:2, occupied: 2, playerlist:{"4":1,"5":1}, readyPlayerList:{}, roomId: 2, state:'waiting'};
roomList[4] =  {shape:"BarShape", player:2, occupied: 1, playerlist:{"6":1}, readyPlayerList:{}, roomId: 3, state:'waiting'};
roomList[5] =  {shape:"BarShape", player:4, occupied: 2, playerlist:{"14":1,"16":1}, readyPlayerList:{}, roomId: 4, state:'waiting'};
roomList[6] =  {shape:"BarShape", player:4, occupied: 3, playerlist:{"12":1,"31":1,"45":1}, readyPlayerList:{}, roomId: 5, state:'waiting'};
roomList[7] =  {shape:"RoundShape", player:4, occupied: 3, playerlist:{"2":1,"9":1,"41":1}, readyPlayerList:{}, roomId: 6, state:'waiting'};
roomList[8] =  {shape:"RoundShape", player:2, occupied: 2, playerlist:{"71":1,"73":1}, readyPlayerList:{}, roomId: 7, state:'waiting'};
roomList[9] =  {shape:"RoundShape", player:2, occupied: 2, playerlist:{"74":1,"75":1}, readyPlayerList:{}, roomId: 8, state:'waiting'};
roomList[10] =  {shape:"RoundShape", player:2, occupied: 1, playerList:{"76":1}, readyPlayerList:{}, roomId: 9, state:'waiting'};
roomList[11] =  {shape:"RoundShape", player:4, occupied: 2, playerlist:{"714":1,"716":1}, readyPlayerList:{}, roomId: 10, state:'waiting'};
roomList[12] =  {shape:"RoundShape", player:4, occupied: 3, playerlist:{"712":1,"731":1,"745":1}, readyPlayerList:{}, roomId: 11, state:'waiting'};
roomList[13] =  {shape:"RoundShape", player:4, occupied: 3, playerlist:{"102":1,"49":1,"741":1}, readyPlayerList:{}, roomId: 12, state:'waiting'};
